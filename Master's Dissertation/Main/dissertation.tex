...
\caption{The optimal parameters for BRISK0 - U-BRISK with KNN Distance}
...
In total $600$ overlapping pairs of images and $600$ non-overlapping pairs of images were generated respectively. Utilising this data, the optimal thresholds for each of the four feature extraction algorithms were calculated using the optimal parameters algorithm detailed in \secref{sec:optimalParameters}. This generated the MTS and CPS parameter values and these are displayed in \tabref{tab:dataset2OptimalThresholds}.\\
