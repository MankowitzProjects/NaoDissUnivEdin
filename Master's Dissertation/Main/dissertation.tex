...
\hline 
BRISK0- SURF2D & 66.627 & 3.516\tabularnewline
\hline 
UBRISK & 0.178 & 0.002\tabularnewline
\hline 
1D SURF & 91.436 & 34.428\tabularnewline
\hline 
 & Radius Matching & \tabularnewline
\hline 
BRISK0 & 0.243 & 0.033\tabularnewline
\hline 
BRISK4 & 0.363 & 0.046\tabularnewline
\hline 
BRISK0- SURF2D & 59.819 & 3.935\tabularnewline
\hline 
UBRISK & 0.208 & 0.017\tabularnewline
\hline 
1D SURF & 91.436 & 34.428\tabularnewline
\hline 
\end{tabular}
...
\hline 
\hline 
BRISK0 & MPS & 90.429 & 3.484 & 6.054 & 1.707 & 0.029 & 15.271\tabularnewline
\hline 
BRISK4 & MPS & 88.084 & 10.882 & 5.882 & 1.571 & 0.029 & 22.422\tabularnewline
\hline 
BRISK0 - SURF2D & MPS & 93.586 & 3.623 & 12.016 & 0.578 & 0.039 & 20.304\tabularnewline
\hline 
\textbf{BRISK0 - U-BRISK} & \textbf{MPS} & \textbf{87.830} & \textbf{3.332} & \textbf{2.595} & \textbf{1.058} & \textbf{0.024} & \textbf{11.005}\tabularnewline
\hline 
BRISK0 & CPS & 93.064 & 4.130 & 11.108 & 6.499 & 0.053 & 25.810\tabularnewline
\hline 
BRISK4 & CPS & 90.768 & 15.842 & 10.970 & 6.744 & 0.057 & 37.662\tabularnewline
\hline 
BRISK0 - SURF2D & CPS & 93.799 & 4.205 & 20.799 & 1.491 & 0.067 & 30.628\tabularnewline
\hline 
BRISK0 - U-BRISK & CPS & 90.350 & 3.832 & 4.051 & 3.775 & 0.042 & 15.709\tabularnewline
\hline 
\textbf{SURF 1D} & \textbf{Given} & \textbf{69.208} & \textbf{0.270} & \textbf{0.134} & \textbf{0.244} & \textbf{0.028} & \textbf{13.185}\tabularnewline
\hline 
\end{tabular}
...
\hline 
\hline 
BRISK0 & MPS & 82.908 & 3.080 & 3.218 & 0.352 & 0.016 & 10.717\tabularnewline
\hline 
BRISK4 & MPS & 76.616 & 8.492 & 3.355 & 0.322 & 0.016 & 16.259\tabularnewline
\hline 
BRISK0-SURF2D & MPS & 86.347 & 3.231 & 7.299 & 0.265 & 0.009 & 14.865\tabularnewline
\hline 
\textbf{BRISK0-UBRISK} & \textbf{MPS} & \textbf{90.378} & \textbf{3.097} & \textbf{1.953} & \textbf{0.360} & \textbf{0.010} & \textbf{9.431}\tabularnewline
\hline 
BRISK0 & CPS & 83.177 & 3.113 & 3.327 & 0.383 & 0.021 & 10.860\tabularnewline
\hline 
BRISK4 & CPS & 80.778 & 9.531 & 4.361 & 0.676 & 0.041 & 18.694\tabularnewline
\hline 
BRISK0-SURF2D & CPS & 86.818 & 3.291 & 8.315 & 0.312 & 0.011 & 15.969\tabularnewline
\hline 
BRISK0-UBRISK & CPS & 89.922 & 3.114 & 1.997 & 0.367 & 0.012 & 9.503\tabularnewline
\hline 
\textbf{SURF 1D} & \textbf{Given} & \textbf{69.208} & \textbf{0.270} & \textbf{0.134} & \textbf{0.244} & \textbf{0.028} & \textbf{13.185}\tabularnewline
\hline 
\end{tabular}
...
ROC curves have been generated for each of the five feature extraction algorithms. These curves have been generated by utilising the overlapping and non-overlapping images respectively. Overlapping images generate the True Positive (TP) matches. This is performed by varying the matching score threshold in a range from the maximum matching score in the dataset to $0$.  All overlapping image pairs with a larger matching score than the threshold are classified as a match and all overlapping image pairs below the matching score are classified as a non-match. The False Positives (FP) are generated from the non-overlapping image pairs. Again, the matching score threshold is varied in the same range and all non-overlapping image pairs above the threshold are defined as a match and vice versa. If a non-overlapping image is defined as a match, then it is a FP. The ROC curves for the five algorithms are shown in \figref{fig:compareHamming} to \figref{fig:compareKNNConsistent} respectively.\\

\figref{fig:compareHamming} and \figref{fig:compareHammingConsistent} shows the ROC curves for the five methods using Radius Matching, and MPS and CPS parameter values respectively which were calculated in \secref{sec:optimalParameters}. It should be noted that, when using the MPS parameters and Radius Matching, BRISK0 - U-BRISK generates the best ROC curve compared to the other algorithms.\\

\figref{fig:compareKNN} shows the ROC curves for 2-NN, using the MPS parameter values. Finally, \figref{fig:compareKNNConsistent} shows the 2-NN matching ROC curves using the CPS. In all of these scenarios, BRISK0 - U-BRISK produces good performance comparable to the other BRISK and SURF-based algorithms.\\
...
\subsubsection{Zero False Positives}
\label{sec:zfp}
...
\hline 
 &  &  & \tabularnewline
\hline 
\textbf{Original Dataset} & 1- Left fluorescent Light Off & 420 & 3024\tabularnewline
\hline 
\textbf{Original Dataset} & 2 -Right fluorescent light and Main Lights off & 420 & 3024\tabularnewline
\hline 
\textbf{Original Dataset} & 3 -Both fluorescent Lights off & 420 & 3024\tabularnewline
\hline 
...
\hline 
\hline 
1 & 96.45 & 96.450 & 2.895 & 1.506 & 0.215 & 0.007\tabularnewline
\hline 
2 & 96.406 & 96.406 & 2.881 & 1.530 & 0.230 & 0.007\tabularnewline
\hline 
3 & 92.223 & 92.223 & 2.976 & 1.704 & 0.294 & 0.008\tabularnewline
\hline 
\end{tabular}
...
\hline 
 & Radius Matching & \tabularnewline
\hline 
Left fluorescent Light Off & 0.128 & 0.009\tabularnewline
\hline 
Right fluorescent light and Main Lights off & 0.128 & 0.006\tabularnewline
\hline 
Both fluorescent Lights off & 0.112 & 0.013\tabularnewline
\hline 
\end{tabular}
\label{tab:lvMS}
\end{table}
...
\subsubsection{Main Robocup Dataset with Nikon Camera}
...
\hline 
\hline 
Nao and Nikon & 81.581 & 2.908 & 1.407 & 0.211 & 0.006 & 10.516\tabularnewline
\hline 
Nao only & 89.943 & 3.114 & 1.997 & 0.367 & 0.012 & 9.503\tabularnewline
\hline 
\end{tabular}
...
\hline 
 & Radius Matching & \tabularnewline
\hline 
Nao only & 0.208 & 0.017\tabularnewline
\hline 
Nao and Nikon & 0.096 & 0.006\tabularnewline
\hline 
\end{tabular}
\label{tab:nkmrdMS}
\end{table}
...
\subsubsection{Large Hall Dataset with Nikon Camera}
...
\subsection{Google Street View Dataset}
