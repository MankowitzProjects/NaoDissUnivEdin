...
clear all
clc
load 'DA_Classification_12062012_0957.mat'%For BRISK SURF
%load 'DA_Classification_14062012_BRISK_BRISK.mat'

%Radius has been set to 0.20
%Threshold has been set to 70
...
tpRateMatrix = zeros(1,1000);
fpRateMatrix = zeros(1,1000);
%Counter
counter = 1;
...
classificationBoundary = meanMatchesScore - ((meanMatchesScore - meanNonMatchesScore)/1.1);
%classificationBoundary =meanNonMatchesScore*2;

%Now to perform classification
data(:,16) = data(:,7)>=ii; 
