...
[msm, mtmm, mbmm, motm, mScore] = createDataMatrices(dataset1Processed, 19,0 , 1);
[msm2, mtmm2, mbmm2, motm2, mScore2] = createDataMatrices(dataset2Processed, 19,0 , 1);
[msm3, mtmm3, mbmm3, motm3, mScore3] = createDataMatrices(dataset3Processed, 19,0 , 1);
[msm4, mtmm4, mbmm4, motm4, mScore4] = createDataMatrices(dataset4Processed, 19,0 , 1);
