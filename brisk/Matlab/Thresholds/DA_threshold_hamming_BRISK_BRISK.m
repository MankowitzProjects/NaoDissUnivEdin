...
[msm, mtmm, mbmm, motm, mScore] = createDataMatrices(dataset1Processed, distance, maxNZM1, 19,0 , 1);
[msm2, mtmm2, mbmm2, motm2, mScore2] = createDataMatrices(dataset2Processed, distance, maxNZM2, 19,0 , 1);
[msm3, mtmm3, mbmm3, motm3, mScore3] = createDataMatrices(dataset3Processed, distance, maxNZM3, 19,0 , 1);
[msm4, mtmm4, mbmm4, motm4, mScore4] = createDataMatrices(dataset4Processed, distance, maxNZM4, 19,0 , 1);


%Calculate the final scores for each dataset
[Parameters(1,1),Parameters(1,2), row, col ] = getThreshold(mScore, threshold, distance);
[Parameters(2,1),Parameters(2,2), row, col ] = getThreshold(mScore2,threshold, distance);
[Parameters(3,1),Parameters(3,2), row, col ] = getThreshold(mScore3,threshold, distance);
[Parameters(4,1),Parameters(4,2), row, col ] = getThreshold(mScore4, threshold, distance);
...
[consistentDistance,consistentThreshold, row, col ] = getThreshold(mScoreSum, threshold, distance);
mScoreSum(row, col)
